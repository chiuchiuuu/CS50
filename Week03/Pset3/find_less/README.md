...
## [tl;dr](http://docs.cs50.net/problems/find/less/find.html#tl-dr)
...
## [Distribution](http://docs.cs50.net/problems/find/less/find.html#distribution)

### [Downloading](http://docs.cs50.net/problems/find/less/find.html#downloading)
...
### [Understanding](http://docs.cs50.net/problems/find/less/find.html#understanding)
...
## [Specification](http://docs.cs50.net/problems/find/less/find.html#specification)

Complete the implementation of `find` by completing the implementation of `search` and `sort` in `helpers.c`.

### [`search`](http://docs.cs50.net/problems/find/less/find.html#code-search-code)
...
### [`sort`](http://docs.cs50.net/problems/find/less/find.html#code-sort-code)
...
## [Usage](http://docs.cs50.net/problems/find/less/find.html#usage)
...
## [Testing](http://docs.cs50.net/problems/find/less/find.html#testing)
...
## [Hints](http://docs.cs50.net/problems/find/less/find.html#hints)
...
For `sort`, odds are you’ll want to implement bubble sort, selection sort, or insertion sort! Just realize that there’s no one "right" way to implement any of those algorithms; variations abound. In fact, you’re welcome to improve upon them as you see fit, so long as your implementation remains in *O*(*n*2). Although you may not alter our declaration of `sort`, you’re welcome to define your own function(s) in `helpers.c` that `sort` itself may then call.
